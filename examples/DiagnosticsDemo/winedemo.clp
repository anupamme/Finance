...
(deftemplate WINES::wine
  ...
  (multislot performance (default any)))

(deffacts WINES::the-wine-list 
  (wine (name "DSP Black Rock - Top 100 equity") (color equity) (body medium) (sweetness debt) (category tech infra))
  (wine (name "Franklin India BlueChip") (color hybrid) (body small) (sweetness growth) (category financial))
  (wine (name "Birla Sunlife - Frontline Equity") (color hybrid) (body medium) (sweetness growth) (category transportation))
  (wine (name "Fidelity Equity") (color hybrid) (body medium large) (sweetness medium growth) (category energy healthcare))
  (wine (name "UTI Dividend Yield") (color hybrid) (body small) (sweetness medium growth) (category healthcare tech))
  (wine (name "AIG India Equity Regular") (color hybrid) (body small medium) (sweetness debt) (category utilities))
  (wine (name "Templeton India Growth") (color hybrid) (body large) (category services))
  (wine (name "DSP BlackRock - Equity Regular 2") (color hybrid) (body small) (sweetness debt) (category conglomerates))
  (wine (name "IDBI Nifty Junior Index 3") (color equity) (body small) (category materials))
  (wine (name "DSP Blackrock - Small and Mid Cap") (color equity) (sweetness growth debt) (category tech))
  (wine (name "HDFC Mid Cap") (color equity) (sweetness growth debt) (category energy infa))
  (wine (name "DSP BlackRock MicroCap") (color equity) (body medium) (sweetness debt)(category tech utilities))
  (wine (name "Fidelity Tax Advantage") (color equity) (body large) (sweetness taxplanning growth) (category financial))
  (wine (name "AIG Infrastructure and Economic Reform") (color equity) (sweetness growth debt) (category financial energy)))
...
(defrule WINES::generate-wines
  ...
  (attribute (name best-category) (value ?p) (certainty ?certainty-4))
  =>
