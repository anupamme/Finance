...
(deftemplate WINES::wine
  ...
  (slot comments (default any)))

(deffacts WINES::the-wine-list 
  (wine (name "DSP Black Rock - Top 100 equity") (fundType equity) (fundCap large) (fundPurpose growth) (comments "Moderate Growth Fund"))
  (wine (name "Franklin India BlueChip") (fundType equity) (fundCap large) (fundPurpose growth) (comments "Growth for Retirement"))
  (wine (name "Franklin India Index NSE Nifty") (fundType equity) (fundCap large) (fundPurpose growth) (comments "Moderate Growth"))
  (wine (name "Goldman Sachs Nifty ETS 1") (fundType equity) (fundCap large) (fundPurpose growth) (comments "For Risk Takers in their 20s"))
  (wine (name "ICICI Prudential - Focussed BlueChip Equity") (fundType equity) (fundCap large) (fundPurpose growth) (comments "For Steady Growth"))
  (wine (name "Kotak - Sensex ETF 1") (fundType equity) (fundCap large) (fundPurpose growth) (comments "Fund with Great History"))
;; mid cap funds.  
(wine (name "Birla Sunlife - Frontline Equity") (fundType equity) (fundCap medium) (fundPurpose growth) (comments "High Performance with risk"))
  (wine (name "Fidelity Equity") (fundType equity) (fundCap medium large) (fundPurpose medium growth) (comments "Great Fund for Children Education"))
  (wine (name "Franklin India Prima Plus") (fundType equity) (fundCap medium large) (fundPurpose medium growth) (comments "Great Fund for 5 year investment"))
...
(defrule WINES::generate-wines
  ...
  =>
  (assert (attribute (name wine) (value ?name) (comments ?comment)
